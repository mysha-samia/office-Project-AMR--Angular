...
@Component({
  selector: 'app-specialists-referral-graph',
  templateUrl: './specialists-referral-graph.component.html',
  styleUrls: ['./specialists-referral-graph.component.scss']
})
export class SpecialistsReferralGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.data !== null)
      this.specialistGraph();
  }

  specialistGraph() {
    Highcharts.chart('specialist', {
      chart: {
