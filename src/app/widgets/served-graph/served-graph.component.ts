...
@Component({
  selector: 'app-served-graph',
  templateUrl: './served-graph.component.html',
  styleUrls: ['./served-graph.component.scss']
})
export class ServedGraphComponent implements OnInit {
