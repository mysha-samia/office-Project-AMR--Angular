...
@Component({
  selector: 'app-new-user-graph',
  templateUrl: './new-user-graph.component.html',
  styleUrls: ['./new-user-graph.component.scss']
})
export class NewUserGraphComponent implements OnInit {
