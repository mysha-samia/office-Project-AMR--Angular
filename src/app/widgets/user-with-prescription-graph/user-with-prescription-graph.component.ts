...
@Component({
  selector: 'app-user-with-prescription-graph',
  templateUrl: './user-with-prescription-graph.component.html',
  styleUrls: ['./user-with-prescription-graph.component.scss']
})
export class UserWithPrescriptionGraphComponent implements OnInit {
  ...
  diagnosticChart() {
    Highcharts.chart('userWithPrescription', {
      chart: {
