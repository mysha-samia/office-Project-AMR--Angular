...
@Component({
  selector: 'app-user-with-medicine-name-graph',
  templateUrl: './user-with-medicine-name-graph.component.html',
  styleUrls: ['./user-with-medicine-name-graph.component.scss']
})
export class UserWithMedicineNameGraphComponent implements OnInit {
  ...
  diagnosticChart() {
    Highcharts.chart('userWithMedicineName', {
      chart: {
