...
@Component({
  selector: 'app-hospital-graph',
  templateUrl: './hospital-graph.component.html',
  styleUrls: ['./hospital-graph.component.scss']
})
export class HospitalGraphComponent implements OnInit {
