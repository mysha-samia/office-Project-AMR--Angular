...
@Component({
  selector: 'app-user-taken-telemedicine-service',
  templateUrl: './user-taken-telemedicine-service.component.html',
  styleUrls: ['./user-taken-telemedicine-service.component.scss']
})
export class UserTakenTelemedicineServiceComponent implements OnInit {
  ...
  diagnosticChart() {
    Highcharts.chart('userTakenTelemedicineService', {
      chart: {
