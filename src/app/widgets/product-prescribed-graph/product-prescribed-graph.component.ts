...
@Component({
  selector: 'app-product-prescribed-graph',
  templateUrl: './product-prescribed-graph.component.html',
  styleUrls: ['./product-prescribed-graph.component.scss']
})
export class ProductPrescribedGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.data !== null)
      this.productPrescribedGraph();
  }

  productPrescribedGraph() {
    Highcharts.chart('productPrescribed', {
      chart: {
